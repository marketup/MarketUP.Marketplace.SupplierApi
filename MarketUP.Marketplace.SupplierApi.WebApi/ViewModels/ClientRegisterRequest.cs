...
namespace MarketUP.Marketplace.Integration.ModelsSupplierApi
{
    public class ClientRegisterRequest
    {
        ...
        public ClientRegisterRequest(string companyName, string cnpj, string ie, string email, string phone, string contactFirstName, string contactLastName, string contactCpf, 
