...
namespace MarketUP.Marketplace.Integration.ModelsSupplierApi
{
    public class ClientUpdateRequest
    {
        ...
        public ClientUpdateRequest(string companyName, string cnpj, string ie, string email, string phone, string contactFirstName, string contactLastName, string contactCpf, 
