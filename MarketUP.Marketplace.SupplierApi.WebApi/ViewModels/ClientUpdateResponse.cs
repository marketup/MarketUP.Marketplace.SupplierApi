...
{
    public class ClientUpdateResponse : BaseResponse
    {
        ...
        public ClientUpdateResponse(string clientID, string companyName, string cnpj, string ie, string email, string phone, string contactFirstName, string contactLastName, string contactCpf,
